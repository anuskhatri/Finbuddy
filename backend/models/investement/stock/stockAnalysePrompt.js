...
const stockAnalysePrompt = async (userId, stockId) => {
  try {
    ...
    const investedAmount =
      Number(stockData.purchased_price) * stockData.quantity;
    ...
    const gptResponse = await getFinancialAdvice(
      `Given the following recent news articles about the stock, determine the overall market sentiment as either positive or negative.
